...
export declare const backgroundColor: import("./types").RestyleFunctionContainer<Record<string, any>, BaseTheme, "backgroundColor", "colors">;
export declare const backgroundColorShorthand: import("./types").RestyleFunctionContainer<Record<string, any>, BaseTheme, "bg", "colors">;
...
export declare const spacing: import("./types").RestyleFunctionContainer<Record<string, any>, BaseTheme, "margin" | "marginBottom" | "marginHorizontal" | "marginLeft" | "marginRight" | "marginTop" | "marginVertical" | "padding" | "paddingBottom" | "paddingHorizontal" | "paddingLeft" | "paddingRight" | "paddingTop" | "paddingVertical", "spacing">[];
export declare const spacingShorthand: import("./types").RestyleFunctionContainer<Record<string, any>, BaseTheme, "m" | "mt" | "mr" | "mb" | "ml" | "mx" | "my" | "p" | "pt" | "pr" | "pb" | "pl" | "px" | "py", "spacing">[];
