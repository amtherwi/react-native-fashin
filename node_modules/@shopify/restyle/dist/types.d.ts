...
export declare type RestyleFunction<TProps extends Record<string, any> = Record<string, any>, Theme extends BaseTheme = BaseTheme, TVal = any> = (props: TProps, context: {
    theme: Theme;
